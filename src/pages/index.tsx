        ...
        <div>
          ...
          >
            ...
            <div className='space-y-5'>
              ...
              <p className='flex flex-col items-center text-3xl font-semibold text-white'>
                Watch anywhere. Cancel anytime.
              </p>
              <p className='flex flex-col items-center text-lg text-white'>
          ...
          <div className='flex h-screen items-center justify-center bg-black p-5'>
            <div className='space-y-5 p-5'>
              <p className='text-4xl font-bold text-white'>Enjoy on your TV.</p>
              <p className='font-semiboldbold text-xl text-white'>
          ...
          <div className='flex h-screen items-center justify-center bg-black p-5'>
            <div className='space-y-5 p-5'>
              <p className='text-4xl font-bold text-white'>Watch everywhere.</p>
              <p className='font-semiboldbold text-xl text-white'>
          ...
          <hr />
          <div className='min-h-screen space-y-10 bg-black'>
            <p className='flex justify-center p-5 text-5xl font-bold text-white'>
              Frequently Asked Questions
            </p>
            <div className='flex flex-col items-center justify-center space-y-5'>
              <div className='w-3/4 bg-[#303030] p-5'>
